            ...
            <section class="content invoice">
                ...
                <div class="  invoice-header">
                    <h1>
                                    ...
                                    <small class="pull-right">{{ $transaksi->tgl }}</small>
                                </h1>
                </div>
                <!-- /.col -->
                </div>
                ...
                <div class="col-sm-4 invoice-col">
                    ...
                    <address>
                                    ...
                                    <br>Phone: {{ $transaksi->member->tlp }}
                                </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                    <b>Kode Invoice #{{ $transaksi->kode_invoice }}</b>
                    <br>
                    <b>{{ $transaksi->outlet->nama }}
                    <br>
                    <b>Payment Due:</b> {{ $transaksi->batas_waktu }}
                </div>
                <!-- /.col -->
                </div>
                <!-- /.row -->
